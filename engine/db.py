...
#Local commands
# query = "INSERT INTO sys_command VALUES (null,'vs code','C:\\Users\\DELL 3400\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe')"
# cursor.execute(query)
# con.commit()
...
#for deleting the contacts from database
# cursor.execute("DELETE FROM contacts")
# con.commit()

# query = "INSERT INTO contacts VALUES (null,'me', '7331192808', 'null')"
# cursor.execute(query)
# con.commit()
